...
export async function handleBuildComplete({
  ...
  if (typeof adapterMod.onBuildComplete === 'function') {
    ...
    for (const route of routesManifest.dynamicRoutes) {
      ...
      // variants prefix. Add one route per declaring page to match every hash
      // and pass the selected combination to the origin.
      //
      ...
      if (variantRoutePages?.has(route.page)) {
        ...
        // values.
        const destinationWithCombination =
          variantsDestination +
        ...
        dynamicRoutes.push({
          ...
          destination: destinationWithCombination,
          has: plainHas,
          missing: undefined,
        })
      }
